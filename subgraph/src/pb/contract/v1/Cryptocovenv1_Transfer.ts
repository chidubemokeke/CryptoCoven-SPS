...
export class Cryptocovenv1_Transfer {
  static encode(message: Cryptocovenv1_Transfer, writer: Writer): void {
    writer.uint32(10);
  ...
  static decode(reader: Reader, length: i32): Cryptocovenv1_Transfer {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Cryptocovenv1_Transfer();
