...
export class Cryptocovenv1_Approval {
  static encode(message: Cryptocovenv1_Approval, writer: Writer): void {
    writer.uint32(10);
    ...
    writer.uint32(50);
    writer.bytes(message.approved);

    writer.uint32(58);
    writer.string(message.tokenId);
  }

  static decode(reader: Reader, length: i32): Cryptocovenv1_Approval {
    const end: usize = length < 0 ? reader.end : reader.ptr + length;
    const message = new Cryptocovenv1_Approval();
  ...
  constructor(
    ...
    approved: Uint8Array = new Uint8Array(0),
    tokenId: string = ""
  ) {
