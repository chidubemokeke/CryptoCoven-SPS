...
pub mod functions {
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct Claim {
        pub merkle_proof: Vec<[u8; 32usize]>,
    }
    impl Claim {
        const METHOD_ID: [u8; 4] = [179u8, 145u8, 197u8, 8u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct ClaimListMerkleRoot {}
    impl ClaimListMerkleRoot {
        const METHOD_ID: [u8; 4] = [50u8, 111u8, 154u8, 211u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            Ok(Self {})
    ...
    impl substreams_ethereum::Function for ClaimListMerkleRoot {
        const NAME: &'static str = "claimListMerkleRoot";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl substreams_ethereum::rpc::RPCDecodable<[u8; 32usize]> for ClaimListMerkleRoot {
    ...
    impl Claimed {
        const METHOD_ID: [u8; 4] = [200u8, 132u8, 239u8, 131u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
    ...
    impl substreams_ethereum::Function for Claimed {
    ...
    impl substreams_ethereum::rpc::RPCDecodable<bool> for Claimed {
        fn output(data: &[u8]) -> Result<bool, String> {
            Self::output(data)
        }
    }
    #[derive(Debug, Clone, PartialEq)]
    pub struct CommunityMintCounts {
        pub param0: Vec<u8>,
    }
    impl CommunityMintCounts {
        const METHOD_ID: [u8; 4] = [55u8, 202u8, 203u8, 17u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
    ...
    impl substreams_ethereum::Function for CommunityMintCounts {
        const NAME: &'static str = "communityMintCounts";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt>
    for CommunityMintCounts {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    #[derive(Debug, Clone, PartialEq)]
    pub struct CommunitySaleMerkleRoot {}
    impl CommunitySaleMerkleRoot {
        const METHOD_ID: [u8; 4] = [158u8, 176u8, 9u8, 116u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            Ok(Self {})
    ...
    impl substreams_ethereum::Function for CommunitySaleMerkleRoot {
        const NAME: &'static str = "communitySaleMerkleRoot";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    for CommunitySaleMerkleRoot {
        fn output(data: &[u8]) -> Result<[u8; 32usize], String> {
            Self::output(data)
        }
    }
    #[derive(Debug, Clone, PartialEq)]
    pub struct CommunitySalePrice {}
    impl CommunitySalePrice {
        const METHOD_ID: [u8; 4] = [190u8, 201u8, 81u8, 7u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            Ok(Self {})
    ...
    impl substreams_ethereum::Function for CommunitySalePrice {
        const NAME: &'static str = "COMMUNITY_SALE_PRICE";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct GetLastTokenId {}
    impl GetLastTokenId {
        const METHOD_ID: [u8; 4] = [131u8, 196u8, 192u8, 13u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            Ok(Self {})
    ...
    impl substreams_ethereum::Function for GetLastTokenId {
        const NAME: &'static str = "getLastTokenId";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct GiftWitches {
        pub addresses: Vec<Vec<u8>>,
    }
    impl GiftWitches {
        const METHOD_ID: [u8; 4] = [223u8, 155u8, 187u8, 130u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
    ...
    impl substreams_ethereum::Function for GiftWitches {
        const NAME: &'static str = "giftWitches";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct IsCommunitySaleActive {}
    impl IsCommunitySaleActive {
        const METHOD_ID: [u8; 4] = [235u8, 72u8, 131u8, 171u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            Ok(Self {})
    ...
    impl substreams_ethereum::Function for IsCommunitySaleActive {
        const NAME: &'static str = "isCommunitySaleActive";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl substreams_ethereum::rpc::RPCDecodable<bool> for IsCommunitySaleActive {
        fn output(data: &[u8]) -> Result<bool, String> {
            Self::output(data)
        }
    }
    #[derive(Debug, Clone, PartialEq)]
    pub struct IsPublicSaleActive {}
    impl IsPublicSaleActive {
        const METHOD_ID: [u8; 4] = [30u8, 132u8, 196u8, 19u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            Ok(Self {})
    ...
    impl substreams_ethereum::Function for IsPublicSaleActive {
        const NAME: &'static str = "isPublicSaleActive";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl substreams_ethereum::rpc::RPCDecodable<bool> for IsPublicSaleActive {
        fn output(data: &[u8]) -> Result<bool, String> {
            Self::output(data)
        }
    }
    #[derive(Debug, Clone, PartialEq)]
    pub struct MaxCommunitySaleWitches {}
    impl MaxCommunitySaleWitches {
        const METHOD_ID: [u8; 4] = [112u8, 208u8, 120u8, 152u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            Ok(Self {})
    ...
    impl substreams_ethereum::Function for MaxCommunitySaleWitches {
        const NAME: &'static str = "maxCommunitySaleWitches";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt>
    for MaxCommunitySaleWitches {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    #[derive(Debug, Clone, PartialEq)]
    pub struct MaxGiftedWitches {}
    impl MaxGiftedWitches {
        const METHOD_ID: [u8; 4] = [61u8, 91u8, 243u8, 46u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            Ok(Self {})
    ...
    impl substreams_ethereum::Function for MaxGiftedWitches {
        const NAME: &'static str = "maxGiftedWitches";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl substreams_ethereum::rpc::RPCDecodable<substreams::scalar::BigInt>
    for MaxGiftedWitches {
        fn output(data: &[u8]) -> Result<substreams::scalar::BigInt, String> {
            Self::output(data)
        }
    }
    #[derive(Debug, Clone, PartialEq)]
    pub struct MaxWitches {}
    impl MaxWitches {
        const METHOD_ID: [u8; 4] = [85u8, 15u8, 43u8, 78u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            Ok(Self {})
    ...
    impl substreams_ethereum::Function for MaxWitches {
        const NAME: &'static str = "maxWitches";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct MaxWitchesPerWallet {}
    impl MaxWitchesPerWallet {
        const METHOD_ID: [u8; 4] = [51u8, 126u8, 98u8, 193u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            Ok(Self {})
    ...
    impl substreams_ethereum::Function for MaxWitchesPerWallet {
        const NAME: &'static str = "MAX_WITCHES_PER_WALLET";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct MintCommunitySale {
        pub number_of_tokens: substreams::scalar::BigInt,
        pub merkle_proof: Vec<[u8; 32usize]>,
    }
    impl MintCommunitySale {
        const METHOD_ID: [u8; 4] = [142u8, 79u8, 134u8, 146u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
    ...
    impl substreams_ethereum::Function for MintCommunitySale {
        const NAME: &'static str = "mintCommunitySale";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct NumGiftedWitches {}
    impl NumGiftedWitches {
        const METHOD_ID: [u8; 4] = [175u8, 242u8, 173u8, 236u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            Ok(Self {})
    ...
    impl substreams_ethereum::Function for NumGiftedWitches {
        const NAME: &'static str = "numGiftedWitches";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct PublicSalePrice {}
    impl PublicSalePrice {
        const METHOD_ID: [u8; 4] = [7u8, 232u8, 158u8, 192u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            Ok(Self {})
    ...
    impl substreams_ethereum::Function for PublicSalePrice {
        const NAME: &'static str = "PUBLIC_SALE_PRICE";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct ReserveForGifting {
        pub num_to_reserve: substreams::scalar::BigInt,
    }
    impl ReserveForGifting {
        const METHOD_ID: [u8; 4] = [108u8, 58u8, 155u8, 74u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(
                &[
                    ethabi::Token::Uint(
                        ethabi::Uint::from_big_endian(
                            match self.num_to_reserve.clone().to_bytes_be() {
                                (num_bigint::Sign::Plus, bytes) => bytes,
                                (num_bigint::Sign::NoSign, bytes) => bytes,
                                (num_bigint::Sign::Minus, _) => {
                                    panic!("negative numbers are not supported")
    ...
    impl substreams_ethereum::Function for ReserveForGifting {
        const NAME: &'static str = "reserveForGifting";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct RollOverWitches {
        pub addresses: Vec<Vec<u8>>,
    }
    impl RollOverWitches {
        const METHOD_ID: [u8; 4] = [56u8, 12u8, 36u8, 223u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
    ...
    impl substreams_ethereum::Function for RollOverWitches {
        const NAME: &'static str = "rollOverWitches";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct SetClaimListMerkleRoot {
        pub merkle_root: [u8; 32usize],
    }
    impl SetClaimListMerkleRoot {
        const METHOD_ID: [u8; 4] = [21u8, 189u8, 235u8, 226u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(
                &[ethabi::Token::FixedBytes(self.merkle_root.as_ref().to_vec())],
            );
            let mut encoded = Vec::with_capacity(4 + data.len());
            encoded.extend(Self::METHOD_ID);
            encoded.extend(data);
    ...
    impl substreams_ethereum::Function for SetClaimListMerkleRoot {
        const NAME: &'static str = "setClaimListMerkleRoot";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct SetCommunityListMerkleRoot {
        pub merkle_root: [u8; 32usize],
    }
    impl SetCommunityListMerkleRoot {
        const METHOD_ID: [u8; 4] = [225u8, 12u8, 96u8, 95u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
    ...
    impl substreams_ethereum::Function for SetCommunityListMerkleRoot {
        const NAME: &'static str = "setCommunityListMerkleRoot";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct SetIsCommunitySaleActive {
        pub u_is_community_sale_active: bool,
    }
    impl SetIsCommunitySaleActive {
        const METHOD_ID: [u8; 4] = [13u8, 60u8, 241u8, 242u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
            ...
            values.reverse();
            Ok(Self {
                u_is_community_sale_active: values
                    .pop()
                    .expect(INTERNAL_ERR)
                    .into_bool()
                    .expect(INTERNAL_ERR),
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(
                &[ethabi::Token::Bool(self.u_is_community_sale_active.clone())],
            );
            let mut encoded = Vec::with_capacity(4 + data.len());
            encoded.extend(Self::METHOD_ID);
            encoded.extend(data);
    ...
    impl substreams_ethereum::Function for SetIsCommunitySaleActive {
        const NAME: &'static str = "setIsCommunitySaleActive";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct SetIsOpenSeaProxyActive {
        pub u_is_open_sea_proxy_active: bool,
    }
    impl SetIsOpenSeaProxyActive {
        const METHOD_ID: [u8; 4] = [228u8, 48u8, 130u8, 247u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
            ...
            values.reverse();
            Ok(Self {
                u_is_open_sea_proxy_active: values
                    .pop()
                    .expect(INTERNAL_ERR)
                    .into_bool()
                    .expect(INTERNAL_ERR),
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(
                &[ethabi::Token::Bool(self.u_is_open_sea_proxy_active.clone())],
            );
            let mut encoded = Vec::with_capacity(4 + data.len());
            encoded.extend(Self::METHOD_ID);
            encoded.extend(data);
    ...
    impl substreams_ethereum::Function for SetIsOpenSeaProxyActive {
        const NAME: &'static str = "setIsOpenSeaProxyActive";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct SetIsPublicSaleActive {
        pub u_is_public_sale_active: bool,
    }
    impl SetIsPublicSaleActive {
        const METHOD_ID: [u8; 4] = [40u8, 202u8, 209u8, 61u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
            ...
            values.reverse();
            Ok(Self {
                u_is_public_sale_active: values
                    .pop()
                    .expect(INTERNAL_ERR)
                    .into_bool()
                    .expect(INTERNAL_ERR),
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(
                &[ethabi::Token::Bool(self.u_is_public_sale_active.clone())],
            );
            let mut encoded = Vec::with_capacity(4 + data.len());
            encoded.extend(Self::METHOD_ID);
            encoded.extend(data);
    ...
    impl substreams_ethereum::Function for SetIsPublicSaleActive {
        const NAME: &'static str = "setIsPublicSaleActive";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct SetVerificationHash {
        pub u_verification_hash: String,
    }
    impl SetVerificationHash {
        const METHOD_ID: [u8; 4] = [36u8, 249u8, 133u8, 233u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
        ...
        pub fn encode(&self) -> Vec<u8> {
            let data = ethabi::encode(
                &[ethabi::Token::String(self.u_verification_hash.clone())],
            );
            let mut encoded = Vec::with_capacity(4 + data.len());
            encoded.extend(Self::METHOD_ID);
            encoded.extend(data);
    ...
    impl substreams_ethereum::Function for SetVerificationHash {
        const NAME: &'static str = "setVerificationHash";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    #[derive(Debug, Clone, PartialEq)]
    pub struct VerificationHash {}
    impl VerificationHash {
        const METHOD_ID: [u8; 4] = [192u8, 195u8, 106u8, 55u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            Ok(Self {})
    ...
    impl substreams_ethereum::Function for VerificationHash {
        const NAME: &'static str = "verificationHash";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl substreams_ethereum::rpc::RPCDecodable<String> for VerificationHash {
        fn output(data: &[u8]) -> Result<String, String> {
            Self::output(data)
        }
    }
    ...
    impl WithdrawTokens {
        const METHOD_ID: [u8; 4] = [73u8, 223u8, 114u8, 140u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
    ...
    impl substreams_ethereum::Function for WithdrawTokens {
        const NAME: &'static str = "withdrawTokens";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
